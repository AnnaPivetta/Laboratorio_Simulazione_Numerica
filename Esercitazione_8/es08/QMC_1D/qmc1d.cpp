...
{
	//return 1.0;
	double sigma=0.6078947368421053;
	double mu=0.8063157894736842; 
	return (exp(-(v-mu)*(v-mu)/(2*sigma*sigma))+exp(-(v+mu)*(v+mu)/(2*sigma*sigma)));
}
...
double variationalWaveFunction_second(double v)
{
	...
	double sigma=0.6078947368421053;
	double mu=0.8063157894736842; 
	return (exp(-(v-mu)*(v-mu)/(2*sigma*sigma)))*(((mu-v)/(sigma*sigma))*((mu-v)/(sigma*sigma))-1/(sigma*sigma)) +(exp(-(v+mu)*(v+mu)/(2*sigma*sigma)))*(((-mu-v)/(sigma*sigma))*((-mu-v)/(sigma*sigma))-1/(sigma*sigma));
}
